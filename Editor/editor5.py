...
from PyQt5.QtWidgets import (QPlainTextEdit, QWidget, QVBoxLayout,
	QApplication, QFileDialog, QMessageBox, QHBoxLayout, QFrame,
	QTextEdit, QToolBar, QComboBox, QLabel, QAction, QLineEdit,
	QToolButton, QMenu, QMainWindow)
from PyQt5.QtGui import (QIcon, QPainter, QTextFormat, QColor,
	QTextCursor, QKeySequence, QClipboard, QTextCharFormat, QPalette)
from PyQt5.QtCore import (Qt, QVariant, QRect, QDir, QFile, QFileInfo,
	QTextStream, QRegExp, QSettings)
	...
	def openFileOnStart(self, path=None):
		if path:
			...
			if inFile.open(QFile.ReadWrite | QFile.Text):
				...
				self.setWindowTitle(f'{self.fname}[*]')
