...
"""
Right-click Menu for QTreeview to add child item, insert item above,
insert item down and delete item

AppendRow method can be used to create child items while InsertRow
method can be used to create sibling items.
"""
