...
To turn a dictionary into a tree using QTreeview widget, the key point
is to have correct mapping relationship between parent item and child
item through ‘unique_id’ and ‘parent_id’. Value of key ‘unique_id’
represents identifier of each item. While value of ‘parent_id’ for an
item represents ‘unique_id’ of this item’s parent item.
"""
